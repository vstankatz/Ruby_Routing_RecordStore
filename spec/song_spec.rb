...
describe '#Song' do
  ...
  before(:each) do
    Album.clear()
    Song.clear()
    @album = Album.new("Giant Steps", nil, 2000, "jazz", "ColTrane", nil)
    @album.save()
  end
  ...
  describe('.find_by_album') do
    it("finds songs for an album") do
      album2 = Album.new("Blue", nil, 1972, "folk", "Joanie Mitchell", nil)
      album2.save
      song = Song.new("Naima", @album.id, nil)
      song.save()
  ...
  describe('#songs') do
    it("returns an album's songs") do
      album = Album.new("Giant Steps", nil, 1960, "jazz", "Coletrane", nil)
      album.save()
      song = Song.new("Naima", album.id, nil)
      song.save()
